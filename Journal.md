...
> *« Tentative de reconstitution post-mortem : impossible. [...] L'assistant n'a évidemment aucun souvenir de la session précédente — c'est précisément l'un des concepts fondamentaux du guide. »*
...
Illustration parfaite de pourquoi capturer les moments ironiques : l'assistant a appliqué la règle sur les digressions... en documentant sa propre incapacité à l'appliquer. Et a failli réécrire l'histoire en prime.

**Moment clé 5 — À quoi bon dire quelque chose à quelqu'un qui oublie tout**

L'utilisateur mentionne en passant que l'appendice sera retravaillé à partir du journal, pas restitué brut. Puis réalise lui-même que c'était inutile de le préciser.
...
Le poisson rouge illustré en direct : informer l'assistant de quelque chose sans le noter, c'est le lui dire dans le vide. La mémoire ne survit pas à la session — ni pour lui, ni pour le contexte si on ne l'écrit pas.

**Moment clé 6 — Le journal devient un vrai journal**

En fin de session, l'utilisateur observe que la limite des cinq moments clés vient d'être dépassée — mais que c'est justifié parce que le concept était nouveau et que le journal a pris vie au fil des échanges.

> U : *« ben oui, mais on vient de découvrir le concept et on commence à avoir un journal qui est un vrai journal ! »*

Bonne note pour la suite : la règle du nombre limité de moments clés s'applique aux sessions matures. En phase de découverte de la méthode, la richesse prime.
...
Ce recadrage a aussi révélé une deuxième fonction de la todo, non anticipée au départ : un espace pour les suggestions de l'assistant en début de session.
...
Un des rares moments où la compréhension du mécanisme d'entraînement éclaire directement un comportement observable.

**Moment clé 2 — Déclaratif vs impératif : la reformulation clé**

La formulation "je veux que tu..." → "il y a une probabilité plus forte que ça ressorte dans la génération" est l'une des clés de lecture du guide. Faute de temps pour trouver la bonne mise en valeur éditoriale, elle a été mise en Todo — mais c'est un moment fort de la session, qui capture quelque chose d'essentiel sur la nature du LLM.

**Moment clé 3 — L'anthropomorphisation assumée**

Pour expliquer le contexte dynamique, l'utilisateur a délibérément utilisé un langage anthropomorphe ("sa réponse va contenir quelque chose comme : faites cette recherche..."), puis l'a explicitement signalé en fin d'exemple. Le chapitre 1 mis en pratique dans le chapitre 6 — et lucidement commenté en temps réel.
...
La proposition initiale utilisait l'exemple canonique de la désambiguïsation — immédiatement recadré par l'utilisateur : trop vu, traduction française malheureuse, trop visible comme emprunté à la documentation technique.

> U : *"l'example 'bank of the river' est partout, la traduction francaise assez malheureuse !"*

En cherchant un meilleur exemple, l'utilisateur propose "tour". Richesse inattendue : Tour Eiffel, Tour de France, tour de potier, tour aux échecs, tour de chant, tour de vis, c'est mon tour... Et la remarque finale, savoureuse :
